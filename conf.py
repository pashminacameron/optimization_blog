...
# Optimization blog build configuration file, created by
# `ablog start` on Sun Jul 29 12:23:17 2018.
#
...
blog_authors = {
    'Pashmina Cameron': ('Pashmina Cameron', None),
}
...
# ONLY needed for ALABASTER and breaks others themes
# html_sidebars = {
#     '**': [ 'about.html',
...
html_theme = 'sphinx_rtd_theme' # classic is another acceptable style
...
htmlhelp_basename = 'Optimizationblogdoc'
